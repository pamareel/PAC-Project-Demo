...
class DashboardController extends Controller
{
    ...
    public function table_GPU_cost_saving($TGX,$year){
        ...
        for ($i = 0; $i < Count($GPU_result) ; $i++) {
            ...
            $content .= '<td style="text-align:center;">'.$GPU_result[$i]->Method.'</td>';
        ...
        $totalPotentialSave_query = "SELECT FORMAT(sum(Potential_Saving_Cost), N'N2') as sc ";
