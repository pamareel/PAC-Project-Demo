        ...
        <div class="col-lg-6 col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class='row center' style="background-color:red;">
                        <div id="hos_drug_donut" class="mt-2 center" style="height:283px; width:100%; background-color:blue; display:inline-block;"></div>
                    </div>
